...
class Config:
    ...
    mode = 'discrete' #either discrete or continous depending on the action set of the game
    ...
    num_policies = 100 #size of the population
    num_episodes = 10000 #number of generations
